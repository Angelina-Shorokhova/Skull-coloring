...
void
preparation (unsigned char *od, int height_image, int width_image)
{
...
void
fGauss (unsigned char *od, unsigned char *cp, int height_image,
	int width_image)
{
  for (i = 2; i < height_image - 1; i++)
	...
	{
	  cp[4 * i * width_image + 4 * j] =
	    0.03 * od[4 * (i - 1) * width_image + 4 * (j - 1)] +
	    0.08 * od[4 * (i - 1) * width_image + 4 * j] +
	    0.03 * od[4 * (i - 1) * width_image + 4 * (j + 1)] +
	    0.13 * od[4 * i * width_image + 4 * (j - 1)] +
	    0.16 * od[4 * i * width_image + 4 * j] +
	    0.13 * od[4 * i * width_image + 4 * (j + 1)] +
	    0.05 * od[4 * (i + 1) * width_image + 4 * (j - 1)] +
	    0.13 * od[4 * (i + 1) * width_image + 4 * j] +
	    0.16 * od[4 * (i + 1) * width_image + 4 * (j + 1)];
	  cp[4 * i * width_image + 4 * j + 1] =
	    0.03 * od[4 * (i - 1) * width_image + 4 * (j - 1) + 1] +
	    0.08 * od[4 * (i - 1) * width_image + 4 * j + 1] +
	    0.03 * od[4 * (i - 1) * width_image + 4 * (j + 1) + 1] +
	    0.13 * od[4 * i * width_image + 4 * (j - 1) + 1] +
	    0.16 * od[4 * i * width_image + 4 * j + 1] +
	    0.13 * od[4 * i * width_image + 4 * (j + 1) + 1] +
	    0.05 * od[4 * (i + 1) * width_image + 4 * (j - 1) + 1] +
	    0.13 * od[4 * (i + 1) * width_image + 4 * j + 1] +
	    0.16 * od[4 * (i + 1) * width_image + 4 * (j + 1) + 1];
	  cp[4 * i * width_image + 4 * j + 2] =
	    0.03 * od[4 * (i - 1) * width_image + 4 * (j - 1) + 2] +
	    0.08 * od[4 * (i - 1) * width_image + 4 * j + 2] +
	    0.03 * od[4 * (i - 1) * width_image + 4 * (j + 1) + 2] +
	    0.13 * od[4 * i * width_image + 4 * (j - 1) + 2] +
	    0.16 * od[4 * i * width_image + 4 * j + 2] +
	    0.13 * od[4 * i * width_image + 4 * (j + 1) + 2] +
	    0.05 * od[4 * (i + 1) * width_image + 4 * (j - 1) + 2] +
	    0.13 * od[4 * (i + 1) * width_image + 4 * j + 2] +
	    0.16 * od[4 * (i + 1) * width_image + 4 * (j + 1) + 2];
	  cp[4 * i * width_image + 4 * j + 3] =
	    0.03 * od[4 * (i - 1) * width_image + 4 * (j - 1) + 3] +
	    0.08 * od[4 * (i - 1) * width_image + 4 * j + 3] +
	    0.03 * od[4 * (i - 1) * width_image + 4 * (j + 1) + 3] +
	    0.13 * od[4 * i * width_image + 4 * (j - 1) + 3] +
	    0.16 * od[4 * i * width_image + 4 * j + 3] +
	    0.13 * od[4 * i * width_image + 4 * (j + 1) + 3] +
	    0.05 * od[4 * (i + 1) * width_image + 4 * (j - 1) + 3] +
	    0.13 * od[4 * (i + 1) * width_image + 4 * j + 3] +
	    0.16 * od[4 * (i + 1) * width_image + 4 * (j + 1) + 3];
	}
    }
  return;
}
...
sec_ver[i * n + 3] = 150;
	       ...
	       && (cp[i] <= 180) & (i < 0.6 * width_image * height_image))
	{
...
sec_ver[i * n + 3] = 150;
	  ...
	  else if (i < 0.8 * width_image * height_image)
	    {
	      
sec_ver[i * n] = 190 - 0.9 * cp[i];
...
sec_ver[i * n + 3] = 150;
	  ...
	  else if ((i < 0.91 * width_image * height_image) && (cp[i] > 120)
		   && (cp[i] <= 160))
	    {
	      
sec_ver[i * n] = 190 - 0.9 * cp[i - 1];
...
sec_ver[i * n + 3] = 150;
	  ...
	  else if ((i < 0.92 * width_image * height_image) && (cp[i] > 160)
		   && (cp[i] <= 255))
	    {
	      
sec_ver[i * n] = 19 - 0.09 * cp[i - 1];
...
sec_ver[i * n + 3] = 150;
	  ...
	  else if ((i < 0.94 * width_image * height_image) && (cp[i] > 0)
		   && (cp[i] <= 120))
	    {
	      
sec_ver[i * n] = 0.3 * cp[i - 1];
...
int main ()
{
  ...
  unsigned char *firstversion = (unsigned char *) malloc (height_image * width_image *sizeof (unsigned char));
